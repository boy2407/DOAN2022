...
{
    [Serializable]
    public partial class Entities_web
    {

        private Entities_web(DbConnection connectionString, bool contextOwnsConnection = true)
            : base(connectionString, contextOwnsConnection) { }
        public static Entities_web CreateEntities(bool contextOwnsConnection = true)
        {
            //Doc file connect
            ...
            fs.Close();
            return new Entities_web(connection);
        }
    }
}
